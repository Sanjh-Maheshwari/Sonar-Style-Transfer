...
class Vgg19(torch.nn.Module):
    ...
    def __init__(self, requires_grad=False, show_progress=False, use_relu=True):
        ...
        # model = models.vgg19(pretrained=False, progress=show_progress)
        # model.load_state_dict(torch.load('/content/drive/MyDrive/Sonar images/data_set/checkpoints/VGG_epochbig6'))
        ...
        # checkpoint = torch.load('/content/drive/MyDrive/Sonar images/data_set/checkpoints/VGG19_normalized6')
